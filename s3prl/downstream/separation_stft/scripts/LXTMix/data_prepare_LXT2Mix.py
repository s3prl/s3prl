...
# Data preparation code for the LXT2Mix dataset
...
parser = argparse.ArgumentParser(description='Prepare LXT2Mix dataset')
parser.add_argument('src_dir', type=str, help='Data directory to LXT2Mix')
