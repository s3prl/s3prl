...
# Data preparation code for the LXT1Mix dataset
...
parser = argparse.ArgumentParser(description='Prepare LXT1Mix dataset')
parser.add_argument('src_dir', type=str, help='Data directory to LXT1Mix')
...
def main():
    ...
    for cond in ["s1", "mix_single", "noise"]:
