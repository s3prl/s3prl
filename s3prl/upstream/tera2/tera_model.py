...
class TeraModel(torch.nn.Module):
    def __init__(
        self,
        cfg: TeraConfig,
        task_cfg: TeraPretrainingConfig,
        dictionaries: List[Any],
    ) -> None:
        super().__init__()
        logger.info(f"TeraModel Config: {cfg}")
    ...
    @classmethod
    def build_model(cls, cfg: TeraConfig, task):
        """Build a new model instance."""

        model = TeraModel(cfg, task.cfg, task.dictionaries)
        return model
