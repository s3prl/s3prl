...
from .model import (MockingjayLayerNorm,MockingjayInputRepresentations, 
    MockingjayIntermediate, MockingjayOutput, MockingjaySelfOutput,
    MockingjaySpecPredictionHead) 
...
class MockingjayAlbertVariantConfig(object):
    """Configuration class to store the configuration of a `MockingjayModel`.
    """
    def __init__(self, config):
        self.downsample_rate = config['albertmockingjayVariant']['downsample_rate']
        self.hidden_size = config['albertmockingjayVariant']['hidden_size']
        self.num_hidden_layers = config['albertmockingjayVariant']['num_hidden_layers']
        self.num_attention_heads = config['albertmockingjayVariant']['num_attention_heads']
        self.hidden_act = config['albertmockingjayVariant']['hidden_act']
        self.intermediate_size = config['albertmockingjayVariant']['intermediate_size']
        self.hidden_dropout_prob = config['albertmockingjayVariant']['hidden_dropout_prob']
        self.attention_probs_dropout_prob = config['albertmockingjayVariant']['attention_probs_dropout_prob']
        self.initializer_range = config['albertmockingjayVariant']['initializer_range']
        self.layer_norm_eps = float(config['albertmockingjayVariant']['layer_norm_eps'])

class MockingjayVariantAttention(nn.Module):
    def __init__(self, config, output_attentions=False, keep_multihead_output=False):
        super(MockingjayVariantAttention, self).__init__()
        self.output_attentions = output_attentions
        self.self = MockingjayOnlyQuerySelfAttention(config, output_attentions=output_attentions,
...
class MockingjayVariantLayer(nn.Module):
    def __init__(self, config, output_attentions=False, keep_multihead_output=False):
        super(MockingjayVariantLayer, self).__init__()
        self.output_attentions = output_attentions
        self.attention = MockingjayVariantAttention(config, output_attentions=output_attentions,
                                               keep_multihead_output=keep_multihead_output)
...
class AlbertMockingJayVariantEncoder(nn.Module):
    def __init__(self, config, output_attentions=False, keep_multihead_output=False):
        super(AlbertMockingJayVariantEncoder, self).__init__()
        self.output_attentions = output_attentions
        layer = MockingjayVariantLayer(config, output_attentions=output_attentions,
                                  keep_multihead_output=keep_multihead_output)
        self.layer = layer
...
class AlbertMockingjayVariantInitModel(nn.Module):
    """ An abstract class to handle weights initialization."""
    def __init__(self, config, *inputs, **kwargs):
        super(AlbertMockingjayVariantInitModel, self).__init__()
        self.config = config
...
class AlbertMockingjayVariantModel(AlbertMockingjayVariantInitModel):
    ...
    def __init__(self, config, input_dim, output_attentions=False, keep_multihead_output=False):
        super(AlbertMockingjayVariantModel, self).__init__(config)
        self.output_attentions = output_attentions
        self.input_representations = MockingjayInputRepresentations(config, input_dim)
        self.encoder = AlbertMockingJayVariantEncoder(config, output_attentions=output_attentions,
                                           keep_multihead_output=keep_multihead_output)
...
class AlbertMockingjayVariantForMaskedAcousticModel(AlbertMockingjayVariantInitModel):
    ...
    def __init__(self, config, input_dim, output_dim, output_attentions=False, keep_multihead_output=False):
        super(AlbertMockingjayVariantForMaskedAcousticModel, self).__init__(config)
        self.output_attentions = output_attentions
        self.Mockingjay = AlbertMockingjayVariantModel(config, input_dim, output_attentions=output_attentions,
                                      keep_multihead_output=keep_multihead_output)
...
class MockingjayOnlyQuerySelfAttention(nn.Module):
    def __init__(self, config, output_attentions=False, keep_multihead_output=False):
        super(MockingjayOnlyQuerySelfAttention, self).__init__()
