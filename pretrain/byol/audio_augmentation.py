# -*- coding: utf-8 -*- #
"""*********************************************************************************************"""
#   FileName     [ pretrain/byol/audio_augmentation.py ]
...
class RandomResizeCrop(nn.Module):
    ...
    def forward(self, lms):
        # make virtual_crop_area empty space (virtual crop area) and copy the input log mel spectrogram to th the center
