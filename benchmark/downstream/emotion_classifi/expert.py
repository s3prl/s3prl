...
from benchmark.downstream.emotion_classifi.model import Model
from benchmark.downstream.emotion_classifi.dataset import IEMOCAPDataset, collate_fn
...
class DownstreamExpert(nn.Module):
    ...
    def __init__(self, upstream_dim, downstream_expert, **kwargs):
        ...
        dataset = IEMOCAPDataset(**self.datarc['train'])
        ...
        self.test_dataset = IEMOCAPDataset(**self.datarc['test'])
