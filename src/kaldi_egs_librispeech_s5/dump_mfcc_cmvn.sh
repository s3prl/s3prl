...
for part in dev_clean test_clean train_clean_100 train_clean_360 train_other_500; do
  ...
  apply-cmvn --utt2spk=ark:$data_root/data/$part/utt2spk  ark:$data_root/mfcc/cmvn_$part.ark scp:$data_root/data/$part/feats.scp ark:- | add-deltas --delta-order=2 ark:- ark:$data_root/mfcc_cmvn/$part/mfcc_cmvn.ark
done
