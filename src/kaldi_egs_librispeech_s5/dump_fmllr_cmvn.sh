...
for part in dev_clean test_clean train_clean_100 train_clean_360 train_other_500; do
  ...
  apply-cmvn --utt2spk=ark:$data_root/fmllr/$part/utt2spk  ark:$data_root/fmllr/$part/data/cmvn_speaker.ark scp:$data_root/fmllr/$part/feats.scp ark:- | add-deltas --delta-order=0 ark:- ark:$data_root/fmllr_cmvn/$part/fmllr_cmvn.ark
done
